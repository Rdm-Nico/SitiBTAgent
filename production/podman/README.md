...
Il file `crontab.sh` è lo script utilizzato da crontab per avviare ogni giorno l'applicativo.
...
il file `monitor.sh` invece viene utilizzato per inviare i messaggi fino ora ricevuti ad il server SQL
